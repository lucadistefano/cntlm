 ...
 */
static void display_status(char *msg, OM_uint32 maj_stat, OM_uint32 min_stat) {
	display_status_1(msg, maj_stat, GSS_C_GSS_CODE);
	if (maj_stat != GSS_S_COMPLETE)
		display_status_1(msg, min_stat, GSS_C_MECH_CODE);
}

static void display_name(char* txt, gss_name_t *name) {
...
static int acquire_name(gss_name_t *target_name, char *service_name, gss_OID oid) {
 ...
 * and -1 is returned.
 */
static int client_establish_context(char *service_name,
...
//		}
	...
	//TODO only for fallback test strcpy(service_name, "HTTP@pbzproxy02.wp.lan");
